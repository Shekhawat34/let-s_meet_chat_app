...
// users -> reciever user id => chats -> current user id -> set data
  ...
  void deleteMessage(
    ...
    try {
      if (isGroupChat) {
        await firestore.collection('groups').doc(receiverUserId).collection('messages').doc(messageId).delete();
      } else {
        await firestore.collection('chats').doc(receiverUserId).collection('messages').doc(messageId).delete();
      }
    } catch (e) {
